...
namespace TMPro.Examples
{
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        private void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                Vector3 capHeightStart =
                    new(topLeft.x, m_Transform.TransformPoint(new Vector3(0, capline, 0)).y, 0);
                Vector3 capHeightEnd =
                    new(topRight.x, m_Transform.TransformPoint(new Vector3(0, capline, 0)).y, 0);
                ...
                Vector3 meanlineStart =
                    new(topLeft.x, m_Transform.TransformPoint(new Vector3(0, meanline, 0)).y, 0);
                Vector3 meanlineEnd =
                    new(topRight.x, m_Transform.TransformPoint(new Vector3(0, meanline, 0)).y, 0);
        ...
        private void DrawDottedRectangle(
            Vector3 bottomLeft,
            Vector3 topRight,
            Color color,
            float size = 5.0f
        ...
        private void DrawSolidRectangle(
            Vector3 bottomLeft,
            Vector3 topRight,
            Color color,
            float size = 5.0f
